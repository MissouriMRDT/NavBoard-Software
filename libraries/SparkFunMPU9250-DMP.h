...
public:
	...
	int badMemory[7] = {0,0,0,0,0,0,0};
	int zMax = -2000;
	int magMin[3] = {2000, 2000, 2000};
	int magMax[3] = {-2000, -2000, -2000};
	float mag_Bias[3] = {39.5349, 12.3781, -124.6062};
	float mag_Scale[3] = {1.0489, 1.1299, 0.8609};
	float currAccelX = 0;
	float currAccelY = 0;
	float currAccelZ = 0;
	float magX = 0;
	...
	float accelX = 0;
	float accelZ = 0;
	//61,612,-280,405,-860,-273,
	//275.5, 342.5, -293.5
	//108.1666667
	//0.392619, 0.315815, -0.368541
