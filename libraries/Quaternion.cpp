...
{//ToDo: pull variable inits to header, put beta variables in init, call begin
  
  //headingOffset = -76;
}

void Quaternion::updateMadgwick(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz)
{
...
void Quaternion::updateMahony(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz) 
{
	deltat = (millis()-lastUpdate)/1000000.0f;
